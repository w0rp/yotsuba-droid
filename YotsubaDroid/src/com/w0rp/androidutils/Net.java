...
public class Net {
    ...
    public static Header authHeader(String username, String password) {
    	return new BasicHeader("Authorization", "Basic " +  base64Auth(username, password));
    }
    
    public static String base64Auth(String username, String password) {
    	return Base64.encodeToString((Util.def(username) + ":" + Util.def(password)).getBytes(), Base64.NO_WRAP);
    }
}

...
public class BoardCatalogAdapter extends PostListAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView txtSubject = (TextView) item.findViewById(
            R.id.catalog_item_subject);
        ...
        TextView txtComment = (TextView) item.findViewById(
            R.id.catalog_item_comment);

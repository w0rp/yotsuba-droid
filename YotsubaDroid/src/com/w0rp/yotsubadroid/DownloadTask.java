...
extends AsyncTask<HttpUriRequest, Object, Long> {
     ...
     */
    private void downloadRequest(HttpUriRequest request) throws IOException,
        CancelledException {
    ...
    private void downloadStream(HttpUriRequest request, InputStream is)
        ...
        while (true) {
            ...
            onDownloadPiece(request.getURI(),
                Arrays.copyOfRange(buffer, 0, readLength));
        }
    }
    ...
    /*
     * This method is called when a download is interrupted, by some error or
     * canceling the task.
     *
